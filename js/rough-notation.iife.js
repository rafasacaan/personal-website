var RoughNotation = function(t) {
    ...
    function h(t) {
        return t.randomizer || (t.randomizer = new s(t.seed || 0)),
        t.randomizer.next()
    }
    ...
    function l(t, e, s) {
        ...
        if (i > 3) {
            ...
            for (let e = 1; e + 2 < i; e++) {
                ...
                o[2] = [t[e + 1][0] + (r * t[e][0] - r * t[e + 2][0]) / 6, t[e + 1][1] + (r * t[e][1] - r * t[e + 2][1]) / 6],
                o[3] = [t[e + 1][0], t[e + 1][1]],
                n.push({
                    op: "bcurveTo",
    ...
    function g(t, e, s, i, n, o, r, h) {
        ...
        return u.push([c(o, h) + e + i * Math.cos(f + 2 * Math.PI + .5 * r), c(o, h) + s + n * Math.sin(f + 2 * Math.PI + .5 * r)]),
        u.push([c(o, h) + e + .98 * i * Math.cos(f + r), c(o, h) + s + .98 * n * Math.sin(f + r)]),
        u.push([c(o, h) + e + .9 * i * Math.cos(f + .5 * r), c(o, h) + s + .9 * n * Math.sin(f + .5 * r)]),
        [u, a]
    }
    function d(t, e) {
        return {
        ...
        case "underline":
            {
                const t = s.y + s.h + g[2];
                for (let e = 0; e < _; e++)
                    e % 2 ? f.push(i(s.x + s.w, t, s.x, t, m)) : f.push(i(s.x, t, s.x + s.w, t, m));
                break
            }
        case "strike-through":
            {
        ...
        case "bracket":
            {
                ...
                for (const h of t) {
                    ...
                    switch (h) {
                    case "bottom":
                        t = [[e, s.y + s.h], [e, r], [i, r], [i, s.y + s.h]];
                        break;
                    case "top":
                        t = [[e, s.y], [e, o], [i, o], [i, s.y]];
                        break;
                    case "left":
                        t = [[s.x, o], [e, o], [e, r], [s.x, r]];
                        break;
                    case "right":
                        t = [[s.x + s.w, o], [i, o], [i, r], [s.x + s.w, r]]
                    }
                    t && f.push(n(t, !1, m))
                }
                break
        ...
        case "crossed-off":
            {
                const t = s.x
                  ...
                  , o = e + s.h;
                for (let s = 0; s < _; s++)
                    s % 2 ? f.push(i(n, o, t, e, m)) : f.push(i(t, e, n, o, m));
                for (let s = 0; s < _; s++)
                    s % 2 ? f.push(i(t, o, n, e, m)) : f.push(i(n, e, t, o, m));
                break
            }
        case "circle":
            {
        ...
        case "highlight":
            {
                ...
                const e = s.y + s.h / 2;
                for (let n = 0; n < _; n++)
                    n % 2 ? f.push(i(s.x + s.w, e, s.x, e, t)) : f.push(i(s.x, e, s.x + s.w, e, t));
                break
            }
        }
        if (f.length) {
    ...
    class _ {
        constructor(t, e) {
            ...
            this._resizeListener = ()=>{
                ...
                setTimeout(()=>{
                    this._resizing = !1,
                    "showing" === this._state && this.haveRectsChanged() && this.show()
                }
                , 400))
            }
            ,
        ...
        set color(t) {
            this._config.color !== t && (this._config.color = t,
            this.refresh())
        }
        get strokeWidth() {
        ...
        set strokeWidth(t) {
            this._config.strokeWidth !== t && (this._config.strokeWidth = t,
            this.refresh())
        }
        get padding() {
        ...
        set padding(t) {
            this._config.padding !== t && (this._config.padding = t,
            this.refresh())
        }
        attach() {
            if ("unattached" === this._state && this._e.parentElement) {
                ...
                if (this._e.insertAdjacentElement(i ? "beforebegin" : "afterend", t),
        ...
        haveRectsChanged() {
            if (this._lastSizes.length) {
                const t = this.rects();
                if (t.length !== this._lastSizes.length)
                    return !0;
                for (let e = 0; e < t.length; e++)
                    if (!this.isSameRect(t[e], this._lastSizes[e]))
                        return !0
            }
            return !1
        }
        ...
        show() {
            ...
            case "showing":
                this.hide(),
                this._svg && this.render(this._svg, !0);
                break;
            case "not-showing":
                this.attach(),
                this._svg && this.render(this._svg, !1)
            }
        }
        hide() {
            if (this._svg)
        ...
        render(t, e) {
            let s = this._config;
            e && (s = JSON.parse(JSON.stringify(this._config)),
            s.animate = !1);
            const i = this.rects();
            let n = 0;
            i.forEach(t=>n += t.w);
        ...
        rects() {
            ...
            if (this._svg)
                if (this._config.multiline) {
                    ...
                    t.push(this.svgRect(this._svg, this._e.getBoundingClientRect()));
            return t
        }
        svgRect(t, e) {
